    ...
    <div className="home ">
      ...
      <section className="d-flex flex-column flex-lg-row custom-gap justify-content-between align-items-center mt-se">
        ...
        <div className="img-container">
          {' '}
          <img alt="section2" src={section2} className="" />
        </div>
      </section>
      ...
      <section className="d-flex flex-column flex-lg-row custom-gap justify-content-between align-items-center mt-se">
        <div className="img-container">
          {' '}
          <img alt="section3" src={section3} className="" />
        </div>
      ...
      <section className="d-flex flex-column align-items-center w-100 mt-100">
        ...
        <div className="d-flex flex-column flex-lg-row align-items-center justify-content-between w-100 mt-40">
          ...
          <div className="img-container">
            <img alt="section4" src={section4} className="" />
          </div>
        </div>
      </section>
      ...
      <section className="d-flex flex-column flex-lg-row custom-gap justify-content-between align-items-center mt-se">
        <div className="img-container">
          <img alt="section5" src={section5} className="" />
        </div>
      ...
      <section className="d-flex flex-column flex-lg-row custom-gap justify-content-between align-items-center mt-se">
        ...
        <div className="img-container">
          {' '}
          <img alt="section6" src={section6} className="" />
        </div>
      </section>
      ...
      <section className="d-flex flex-column flex-lg-row custom-gap justify-content-between align-items-center mt-se">
        <div className="img-container">
          {' '}
          <img alt="section7" src={section7} className="" />
        </div>
