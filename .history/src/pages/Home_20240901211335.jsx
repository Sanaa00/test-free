  ...
  return (
    <div className="home">
      ...
      <section className="s2">
        ...
        <img alt="hhhhhhhhhh image" src={section2} className="s3-img se2-img" />
      </section>

      <section className="s3">
        <img alt="hhhhhhhhhh image" src={section3} className="s3-img se3-img" />
        <span>
      ...
      <section className="s4">
        <div className="des-s4">
          <p className="s4-title">Multiple Currencies</p>
          <p className="s4-des">
        ...
        <div className="s4-content">
          ...
          <img
            alt="hhhhhhhhhh image"
            src={section4}
            className="s3-img se4-img"
          />
        </div>
      </section>

      <section className="s3">
        <img alt="hhhhhhhhhh image" src={section5} className="s3-img se5-img" />
        <span>
      ...
      <section className="s3">
        <span>
          <p className="s6-title">Lower Transaction Fees</p>
          <p className="s6-des">
        ...
        <img alt="hhhhhhhhhh image" src={section6} className="s3-img se6-img" />
      </section>

      <section className="s3">
        <img alt="hhhhhhhhhh image" src={section7} className="s3-img se7-img" />
        <span>
