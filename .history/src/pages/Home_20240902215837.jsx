  ...
  return (
    <div className="home ">
      <section className="d-flex justify-content-center align-items-center flex-column">
        <p className="fs-1 text-center fw-bold mb-2 mt-5">
      ...
      <section className="d-flex flex-column flex-lg-row custom-gap justify-content-between align-items-center mt-se">
        <span>
          <Texts text={sectionTwo} />
        </span>
        <div className="img-container">
          {' '}
          <img alt="section2" src={section2} className="s2-img" />
        </div>
      </section>
      ...
      <section className="d-flex flex-column flex-lg-row custom-gap justify-content-between align-items-center mt-se">
        <div className="img-container">
          {' '}
          <img alt="section3" src={section3} className="s3-img" />
        </div>

        <span>
          <p className="s5-p fw-bold mx-0 px-0 mb-30">Secure Transactions</p>
      ...
      <section className="d-flex flex-column align-items-center w-100 mt-100">
        ...
        <div className="d-flex flex-column flex-lg-row align-items-center justify-content-between w-100 mt-40">
          {' '}
          <span>
            {' '}
          ...
          <div className="img-container">
            <img alt="section4" src={section4} className="s4-img" />
          </div>
        </div>
      </section>
      ...
      <section className="d-flex flex-column flex-lg-row custom-gap justify-content-between align-items-center mt-se">
        <div className="img-container">
          <img alt="section5" src={section5} className="s5-img" />
        </div>

        <span>
          <p className="s5-p fw-bold mx-0 px-0 py-0 mb-30">
      ...
      <section className="d-flex flex-column flex-lg-row custom-gap justify-content-between align-items-center mt-se">
        <span>
          ...
          <p className="f-17 mx-0 px-0 py-0 mb-30 ">
        ...
        <div className="img-container">
          {' '}
          <img alt="section6" src={section6} className="s6-img" />
        </div>
      </section>
      ...
      <section className="d-flex flex-column flex-lg-row custom-gap justify-content-between align-items-center mt-se">
        <div className="img-container">
          {' '}
          <img alt="section7" src={section7} className="s7-img" />
        </div>
