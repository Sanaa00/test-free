  ...
  return (
    <div className="home ">
      ...
      <section className="d-flex flex-column align-items-center w-100 mt-100">
        ...
        <div className="d-flex flex-column flex-md-row align-items-center justify-content-between w-100 mt-40">
          {' '}
          <span>
            {' '}
      ...
      <section className="d-flex flex-column flex-md-row custom-gap justify-content-between align-items-center mt-se">
