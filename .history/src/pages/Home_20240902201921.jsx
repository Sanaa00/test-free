  ...
  return (
    <div className="home">
      ...
      <section className="d-flex flex-row custom-gap justify-content-between align-items-center mt-se">
        ...
        <span>
          <p className="s5-p fw-bold">Secure Transactions</p>
      ...
      <section className="d-flex flex-column align-items-center w-100 mt-100">
        <div className="d-flex flex-column text-center">
          <p className="fw-bold f-32">Multiple Currencies</p>
          <p className="f-17">
      ...
      <section className="d-flex flex-row custom-gap justify-content-between align-items-center mt-se">
        ...
        <span>
          <p className="s5-p fw-bold">Accept Cryptocurrency Payments</p>
      ...
      <section className="d-flex flex-row custom-gap justify-content-between align-items-center mt-se">
        <span>
          <p className="s5-p fw-bold mx-0">Lower Transaction Fees</p>
          <p className="f-17">
